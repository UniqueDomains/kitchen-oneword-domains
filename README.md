# Available .KITCHEN One-Word Domains (9,177)
...
> **Important:** this repository is a **public 9,175-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **9,177 domains** on the canonical page below.

**Public extract:** 9,175 rows · **Live catalog:** 9,177 domains
...
| green.kitchen   | premium   | $520      | $520          | 108            | 45     | 5      | namecheap                                                 |
...
| ----------------------- | ------------------------------------------------ |
| 9,175-row public sample | 9,177 live domains                               |
...
> Unique Domains. *Available .KITCHEN One-Word Domains*. Version 2026-04-12. Public GitHub extract for the exact Unique Domains search represented by this repository.
